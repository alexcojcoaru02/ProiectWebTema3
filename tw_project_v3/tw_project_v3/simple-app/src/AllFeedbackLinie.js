...
class AllFeedbackLinie extends Component {
  ...
  fdbkbylinie = () => {
    ...
    axios
      .get("http://localhost:8080/feedback1/" + linie)
      .then((res) => {
        console.log(linie);
        this.setState({
          feedbacks: res.data,
  ...
  fdbkbyMijloc = () => {
    ...
    axios
      .get("http://localhost:8080/feedbackByMijlocTransport/" + mijloc)
      .then((res) => {
        console.log(mijloc);
        this.setState({
          feedbacks: res.data,
  ...
  fdbkbyStatiePlecare = () => {
    ...
    axios
      .get("http://localhost:8080/feedback/" + statiePlecare)
      .then((res) => {
        ...
        <div id="search">
          ...
          <div id="butoane">
            ...
            <Button
              ...
              variant="contained"
              color="primary"
              onClick={this.fdbkbyStatiePlecare}
            >
              Cauta dupa statie plecare
            </Button>
            <Button
              value="Open"
              variant="contained"
              color="primary"
              onClick={this.fdbkbyMijloc}
            >
              Cauta dupa mijloc transport
            </Button>
          </div>
        </div>
